# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 12:02:49 2023
...
os.chdir('C:/Users/dell/OneDrive/Desktop/MtechFinalProject/March2023/differentRegistrations/differentRegistrations/AKAZE')

from registrationAGR import register_images
...
while(True):
    ...
    registered_img,no_of_matches,num_inliers = register_images(img1_color,img2_color) # Image registration
    #print(len(no_of_matches))
    avg_match_len=avg_match_len+len(no_of_matches)
    inliers = inliers+num_inliers
  
    #cv2.imwrite('outputAGR/regAGR/AGR'+y+'.png',registered_img)
