...
os.chdir('C:/Users/dell/OneDrive/Desktop/MtechFinalProject/March2023/differentRegistrations/differentRegistrations/BRISK')

from registrationBUM import register_images
...
while(True):
    ...
    #cv2.imwrite('outputBUM/regBUM/BUM'+y+'.png',registered_img)
