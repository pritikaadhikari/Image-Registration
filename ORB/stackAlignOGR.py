...
os.chdir('C:/Users/dell/OneDrive/Desktop/MtechFinalProject/March2023/differentRegistrations/differentRegistrations/ORB')

from registrationOGR import register_images
...
while(True):
    ...
    #print("Saved")
    #cv2.imwrite('outputOGR/regOGR/OR'+y+'.png',registered_img)
