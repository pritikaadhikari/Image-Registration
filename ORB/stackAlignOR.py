"""
Created on Mon Apr  3 15:07:34 2023
...
from registrationKR import register_images
...
while(True):
    ...
    y = str(x)
    img1_color = cv2.imread(r'../outputAugnented/Input1/test'+y+'.png')  # Image to be aligned.
    ...
    #plt.imshow(img1_color)C:/Users/dell/OneDrive/Desktop/MtechFinalProject/March2023/differentRegistrations/differentRegistrations/outputAugmented/test10.png
    #plt.show()
    
    #print('test'+y+'transformed.jpg')
    #cv2.imwrite('t'+y+'.jpg',transformed_img)   # Show aligned image
    #print("Saved")
    cv2.imwrite('opt/opt2/KR'+y+'.png',registered_img)
    ...
    images.append(registered_img)  # Generating 2D image list
    #calcuate ssim
    """
    ...
    #precision=num_inliers/(len(no_of_matches)+(num_inliers))
