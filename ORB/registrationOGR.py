# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 16:48:56 2023
...
def register_images(image1, image2,y):
    ...
    cv2.imwrite('outputOGR/matchesOGR/OGR'+y+'.png',img_matches)
...
'''
    ...
    homography, mask = cv2.findHomography(src_pts, dst_pts, cv2.USAC_ACCURATE)
